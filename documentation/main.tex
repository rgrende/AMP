...
\begin{itemize}
    ...
    \begin{description}
        \item \includegraphics[width=3cm]{Images/File Create JMenu.png}
    ...
    \end{description}
    \begin{description}
        \item \includegraphics[width=3cm]{Images/File Create New Playlist.png}
    \end{description}
    ...
    \end{description}
    \begin{description}
        \item \includegraphics[width=3cm]{Images/File Create New Tag.png}
    \end{description}
    ...
    \end{description}
        \begin{description}
        \item \includegraphics[width=3cm]{Images/File Create New Screen.png}
    \end{description}
    ...
    \end{description}
        \begin{description}
        \item \includegraphics[width=3cm]{Images/File Create New Song.png}
    \end{description}
    ...
    \end{description}
        \begin{description}
        \item \includegraphics[width=3cm]{Images/File Exit.png}
    \end{description}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{description}
        ...
        \item \includegraphics[width=2.2cm]{Images/Edit Clip.png}
        \item[]Supported audio files: \faIcon{file-audio}
        \item[-]\textbf{.mp3}
        \item[-]\textbf{.wav}
    \end{description}
    ...
    \begin{description}
        ...
        \item \includegraphics[width=2.2cm]{Images/Edit Tags.png}
    \end{description}
